# SmartTube-AA — rejestr paczek i patchy

Ten plik jest kumulatywną checklistą prac od początku tej rozmowy. Będzie aktualizowany po każdym kolejnym etapie. Na zakończenie projektu ma stanowić jedno źródło informacji: jaka paczka była bazą, jaki patch do niej należał i co dokładnie zmieniała.
